  ...
  return (
    <>
      ...
      <Dialog>
        ...
        <DialogContent className="w-80 md:w-100 rounded-xl">
          <DialogHeader>
            <DialogTitle>Edit Your NFT</DialogTitle>
          </DialogHeader>
          <div className="w-full p-6 h-100 md:h-120 flex flex-col items-center justify-between">
            <Image
              className="rounded-xl"
              src={"/images/demo.jpeg"}
              alt="NFT Image"
              ...
              height={300}
            />
            <span className="w-full">Demo NFT</span>
            <span className="w-full">This is a description of Demo NFT</span>
          </div>
        </DialogContent>
      </Dialog>
    </>
